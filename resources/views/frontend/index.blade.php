                            ...
                            <div
                                ...
                                <div class="show-case">
                                    <div class="hero-slide-image">
                                        <img src="{{asset('dashboard/frontend/assets/images/slider-image/slider-2-1.png')}}" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container align-self-center">
                        <div class="row">
                            ...
                            <div
                                ...
                                <div class="show-case">
                                    <div class="hero-slide-image">
                                        <img src="{{asset('dashboard/frontend/assets/images/slider-image/slider-2-2.png')}}" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="single-feature">
                        <div class="feature-icon">
                            <img src="{{asset('dashboard/frontend/assets/images/icons/1.png')}}" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-md-30px mb-lm-30px mt-lm-30px">
                    <div class="single-feature">
                        <div class="feature-icon">
                            <img src="{{asset('dashboard/frontend/assets/images/icons/2.png')}}" alt="">
                        </div>
                        <div class="feature-content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-feature">
                        <div class="feature-icon">
                            <img src="{{asset('dashboard/frontend/assets/images/icons/3.png')}}" alt="">
                        </div>
                        <div class="feature-content">
        ...
        <div class="row m-0">
           ...
           <div class="col-12 col-lg-4 mb-4">
                <div class="single-banner-2">
                    ...
                    <div class="item-disc">
                        <h4 class="title">{{$category->category_tag}} <br>
                            {{$category->category_name}}</h4>
                        <a href="{{route('categorywiseproduct',$category->id)}}" class="shop-link btn btn-primary">Shop Now <i
