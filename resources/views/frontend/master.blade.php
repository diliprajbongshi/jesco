...
<head>
    ...
    <!-- Add site Favicon -->
    <link rel="shortcut icon" href="{{asset('dashboard/frontend/assets/images/favicon/favicon.ico')}}" type="image/png">
    ...
    <link rel="stylesheet" href="{{asset('dashboard/frontend/assets/css/vendor/vendor.min.css')}}" />
    <link rel="stylesheet" href="{{asset('dashboard/frontend/assets/css/plugins/plugins.min.css')}}" />
    <link rel="stylesheet" href="{{asset('dashboard/frontend/assets/css/style.min.css')}}">
...
<body>
            ...
            <div class="container position-relative">
                <div class="row">
                    ...
                    <div class="col align-self-center d-none d-lg-block">
                        <div class="main-menu">
                            <ul>
                                <li class="dropdown"><a href="{{url('/')}}">Home <i class="pe-7s-angle-down"></i></a>
                    ...
                    <div class="col col-lg-auto align-self-center pl-0">
                        <div class="header-actions">
                            ...
                            <a href="#offcanvas-cart"
                                ...
                                <span class="header-action-num">{{cart_count()}}</span>
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset('uploads/product/')}}/{{$wish->relation_product->product_img}}"
                                alt="Cart product Image"></a>
                        <div class="content">
                            <a href="single-product.html" class="title">{{$wish->relation_product->name}}</a>
                            <span class="quantity-price">1 x <span class="amount">${{$wish->relation_product->price}}</span></span>
                            <a href="{{route('wishlish.remove',$wish->id)}}" class="remove">×</a>
                        </div>
                    </li> 
                    @endforeach
                </ul>
            ...
            <div class="foot">
                <div class="buttons">
                    <a href="{{route('wishlish.view')}}" class="btn btn-dark btn-hover-primary mt-30px">view wishlist</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset('uploads/product/')}}/{{$cart->relation_product->product_img}}"
                                alt="Cart product Image"></a>
                        <div class="content">
                            <a href="single-product.html" class="title">{{$cart->relation_product->name}}</a>
                            <span class="quantity-price">{{$cart->amount}} x <span class="amount">${{$cart->relation_product->price}}</span></span>
                            <span>${{$cart->amount * $cart->relation_product->price}}</span>
            ...
            <div class="foot">
                <div class="buttons mt-30px">
                    <a href="{{route('view.cart')}}" class="btn btn-dark btn-hover-primary mb-30px">view cart</a>
    ...
    <div id="offcanvas-mobile-menu" class="offcanvas offcanvas-mobile-menu">
        ...
        <div class="inner customScroll">
            ...
            <div class="offcanvas-menu mb-4">
                <ul>
                    <li><a href="href="{{route('home')}}""><span class="menu-text">Home</span></a>
            ...
            <div class="modal-dialog p-0" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <form class="navbar-form position-relative" role="search" action="" method="POST">
                            @csrf
                            <div class="form-group">
                                <input type="text" name="name" class="form-control" placeholder="Search here...">
                            </div>
                            <button class="submit-btn"><i class="pe-7s-search"></i></button>
                        </form>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-body">
                        <div class="login-content">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <input type="text" type="email" id="emailaddress" name="email" placeholder="Enter your email">
                                <input type="password" placeholder="Password" type="password" name="password" id="password">
    ...
    <!-- Vendor JS -->
     {{-- <script src="{{asset('dashboard/frontend/assets/js/vendor/jquery-3.6.0.min.js')}}"></script>
    <script src="{{asset('dashboard/frontend/assets/js/vendor/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('dashboard/frontend/assets/js/vendor/jquery-migrate-3.3.2.min.js')}}"></script>
    <script src="{{asset('dashboard/frontend/assets/js/vendor/modernizr-3.11.2.min.js')}}"></script> --}}

    <!--Plugins JS-->
     {{-- <script src="{{asset('dashboard/frontend/assets/js/plugins/swiper-bundle.min.js')}}"></script>
    <script src="{{asset('dashboard/frontend/assets/js/plugins/jquery-ui.min.js')}}"></script>
    <script src="{{asset('dashboard/frontend/assets/js/plugins/jquery.nice-select.min.js')}}"></script>
    <script src="{{asset('dashboard/frontend/assets/js/plugins/countdown.js')}}"></script>
    <script src="{{asset('dashboard/frontend/assets/js/plugins/scrollup.js')}}"></script>
    <script src="{{asset('dashboard/frontend/assets/js/plugins/jquery.zoom.min.js')}}"></script>
    <script src="{{asset('dashboard/frontend/assets/js/plugins/venobox.min.js')}}"></script>
    <script src="{{asset('dashboard/frontend/assets/js/plugins/ajax-mail.js')}}"></script>  --}}

    
     {{-- <link rel="stylesheet" href="{{asset('dashboard/frontend/assets/css/style.min.css')}}"> --}}
    <!-- Use the minified version files listed below for better performance and remove the files listed above -->
    <script src="{{asset('dashboard/frontend/assets/js/vendor/vendor.min.js')}}"></script>
    <script src="{{asset('dashboard/frontend/assets/js/plugins/plugins.min.js')}}"></script>

    <!-- Main Js -->
    <script src="{{asset('dashboard/frontend/assets/js/main.js')}}"></script>
