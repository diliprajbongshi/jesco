                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div class="user-box">
                        ...
                        <div class="user-img d-flex">
                            <img src="{{asset('uploads/profile')}}/{{Auth::user()->profile}}" alt="user-img" title="Mat Helme" class="rounded-circle img-fluid">
                            <div class="mt-4 ml-4">
                                <span ><label for=""><a style="color: #000" href="{{route("main")}}">Website</a></label></span>
                            </div>
                        </div>
                        @endauth
                           ...
                           @auth
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{route('user.list')}}"> Email Offer</a></li>
                                </ul>
                            </li> 
                            @endif
                            @if (auth()->user()->role == 2)
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                        ...
                                        {{-- <li><a href="{{route('category.index')}}"> Vendor List</a></li> --}}
                                </ul>
                            </li> 
                            <li>
                            ...
                            <li>
                                <a href="javascript: void(0);"><i class="fi-layers"></i> <span> All Orders </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                        <li><a href="{{route('all.orders')}}">All order</a></li>
                                </ul>
                            </li> 
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                        ...
                                        <li><a href="{{route('location.list')}}">List of Location</a></li>
                                </ul>
                            </li> 
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                        ...
                                        <li><a href="{{route('thumLsit')}}"> Thumblist List</a></li>
                                </ul>
                            </li> 
                            <li>
                            ...
                            @if (auth()->user()->role == 1)
                                <li>
                                    <a href="javascript: void(0);"><i class="fi-layers"></i> <span> My Orders </span> <span class="menu-arrow"></span></a>
                                    <ul class="nav-second-level" aria-expanded="false">
                                        <li><a href="{{route('my.orders')}}"> Order Lsit</a></li>
                                    </ul>
                                </li> 
                            @endif
                           @endauth
                        ...
                        <ul class="list-unstyled topbar-right-menu float-right mb-0">
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button"
                                   aria-haspopup="false" aria-expanded="false">
                                    @auth
                                    <img src="{{asset('uploads/profile')}}/{{Auth::user()->profile}}" alt="user" class="rounded-circle">
                                    @endauth <span class="ml-1">{{Auth::user()->name?? ''}}<i class="mdi mdi-chevron-down"></i> </span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated profile-dropdown ">
                                    ...
                                    <a href="{{route('profile')}}" class="dropdown-item notify-item">
                                        <i class="fi-cog"></i> <span>Profile</span>
                                    </a>
